...
![30% center](img/009.png)

### IFTTT (if this, then that) とは？
LINE, Twitter, Slack など，様々なWebサービス同士を
簡単に連携(レシピと呼ぶ)できるサービス
　　　　　　![12%](img/insta.png)![12%](img/twitter.png)![12%](img/sms22.png)![12%](img/ios.png)![12%](img/rss.png)![12%](img/google.png)
...
「Create action」 をクリック 
![30% center](img/017.png)

---
## ⑴ IFTTTにレシピを作成
<font color="Blue">[Thatの設定]</font>　 「Finish」をクリック 
![28% center](img/021.png)
...
##  ⑵ Secret Key を取得
### webhooks で検索
![38% center](img/022.png)

---
##  ⑵ Secret Key を取得
### 「Services」をクリックし，webhooksのアイコンをクリック
 ![30% center](img/023.png)

---
##  ⑵ Secret Key を取得
### 右上の「Settings」をクリック
![30% center](img/024.png)

---
##  ⑵ Secret Key を取得
### URLの末尾の自身のSecret Keyをコピー
![50% center](img/040.png)
...
![67% ](./img/nefry_top_page.png)![60% ](./img/setup_wifi.png)
...
それぞれ入力し，保存．
![60% center](img/027.png)

---
## ⑶ Nefry BT の設定ページでSecret Key を登録
Nefry BTのボタンを押して試してみましょう！
![60% center](img/028.png)
...
![23% center](img/aruduino_install.png)
